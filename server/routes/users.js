...
// Engineers dropdown for the create-ticket / site-assignment forms   any
// authenticated staff can read this.
router.get('/engineers', async (req, res) => {
  const [rows] = await pool.query(`${SELECT} WHERE r.name = 'Engineer' AND u.is_active = 1 ORDER BY u.full_name`);
